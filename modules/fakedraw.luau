--[[
Thank you enkei for providing this for me, this saved lots of time

This solves many issues with some executors with custom drawing libs that have common issues (synz)
]]
